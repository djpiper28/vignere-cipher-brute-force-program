  ...
  letterCounter:=1;
   while(letterCounter<=length( Text )) do begin
     if(arrayThing[letterCounter]>=maxNum) then begin
       maxChrNum:=Integer(ord(arrayThing[letterCounter]));
...
begin
  ...
  //TEMP
    _cipherText:='';
    //TEMP
  _key:='---------A';
  continue:=True;
  repeat
